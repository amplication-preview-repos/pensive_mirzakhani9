...
import { COLLEGE_TITLE_FIELD } from "./CollegeTitle";
import { DEPARTMENT_TITLE_FIELD } from "../department/DepartmentTitle";

export const CollegeShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="User" target="collegeId" label="Users">
