...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => College, {
    nullable: true,
    name: "college",
  })
  async getCollege(@graphql.Parent() parent: User): Promise<College | null> {
    const result = await this.service.getCollege(parent.id);
